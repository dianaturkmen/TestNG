...
public void setUp() {
 ...
 public void test01(){
    ...
    driver.findElement(By.xpath("//a[text()='Purchase Foreign Currency']")).click();
     ...
     System.out.println("Hard assertion da ilk assertion fail olsaydi, bu satir calismazdi");
     // 10. soft assert kullanarak DropDown listesinin su secenekleri oldugunu test
     // edin "Select One", "Australia (dollar)", "Canada (dollar)", "Switzerland (franc)", "China (yuan)", "Denmark (krone)", "Eurozone (euro)", "Great Britain (pound)", "Hong Kong (dollar)", "Japan (yen)", "Mexico (peso)", "Norway (krone)", "New Zealand (dollar)", "Sweden (krona)", "Singapore (dollar)", "Thailand (baht)"
